        ...
        google.maps.event.addListener( marker, 'click', ( 
          function( marker, i ) {
            return function() {
              ...
              infowindow.setContent("License Plate: "+locations[i]["VNO"]+"<br>Driver: "+locations[i]["DNM"]+" "+locations[i]["DSN"]+"<br>ID: "+locations[i]["terminal_id"]+"<br>Latitude: "+locations[i]["latitude"]+"<br>Longitude: "+locations[i]["longitude"]+"<br>Speed: "+locations[i]["ground_speed"]+"<br>Mileage(km): "+locations[i]["odometer"]+"<br>ACC: "+locations[i]["engine_on"]);

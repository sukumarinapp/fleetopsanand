...
/*        $VNO = "GT4298-18";
    ...
    public function locations()
    {
        ...
        $sql = "select a.VNO,b.capture_date,b.capture_time,b.direction,terminal_id,latitude,longitude,ground_speed,odometer,engine_on from vehicle a,current_location b where a.VTV=1 ".$filter." and a.TID=b.terminal_id and b.id in (select max(id) from current_location where current_date='$today' group by terminal_id)";
